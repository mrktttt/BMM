...
public class SelectFrame extends JFrame{
    ...
    public SelectFrame(Factory fact, Entreprise ent) {
    ...
    public void initTable() {
		...
		while (it.hasNext()) {
			...
			tableModel.addRow(new String[]{String.valueOf(ent.getNumero())+"-"+ent.getNom(),ent.valeurAction() + " €",ent.getDomaine()});
		}
    }
    ...
    private class TableAction implements ListSelectionListener{            
        ...
        public void valueChanged(ListSelectionEvent e)
        {
			...
			fact.getLogger().info("Entreprise selectionnée : " + ent.getNom());
			setVisible(false);               
        }
    }
}
